...
from modules.personas.usuarios import usuarios_repository as db
...
from . import auth_repository as auth_db
...
def iniciar_sesion(dni, password):
    ...
    if not usuario.get("email_verificado", True):
        raise ValidationError("Tenés que finalizar tu registración desde el email que te enviamos")
